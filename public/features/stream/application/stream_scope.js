...
export function requireScope(scope, country) {
  if (!scope) {
...
export function listAvailableLevels(scope) {
...
export function listAvailableYears(scope, level) {
...
export function requireAvailableLevel(scope, level) {
  const selectedLevel = comparisonKey(level);
...
export function requireAvailableYear(scope, level, year) {
...
export function syllabusMatchesScope(syllabus, { country, level, year }) {
  return syllabus
